...
!(function (t, e) {
    ...
    function S(t, e, r) {
        ...
        var a = r.w,
            ...
            s = e.rotation,
            u =
                Math.abs((a / 2) * Math.cos(s)) +
                Math.abs((l / 2) * Math.sin(s)),
            f =
                Math.abs((a / 2) * Math.sin(s)) +
